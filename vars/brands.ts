...
export const BRANDS: Brand = {
  ACL: {
    ...
    metaDescription:
      "Boost your Mustang's engine performance with ACL Race Series bearings. Proven technology for racetrack-level performance and durability. Trust in ACL's rich motorsport history for top-quality engine parts.",
    media: {
      youTube: false,
    },
  },
  DBA: {
    ...
    metaDescription:
      "Choose DBA for reliable, superior Mustang performance. Offering award-winning brake rotors by Australia's global leader in brake manufacturing.",
    media: {
  ...
  HAWK: {
    ...
    metaDescription:
      "Experience superior control and command with Hawk Performance brake pads for your Mustang. Improving friction technologies for supreme vehicle performance.",
    media: {
  ...
  PEDDERS: {
    ...
    metaDescription:
      "Explore Australia's No.1 suspension and brake parts producer, Pedders. Perfect for Mustangs and high-performance vehicles, enhancing steering, load carrying, and towing capabilities",
    media: {
  ...
  TURBOSMART: {
    ...
    metaDescription:
      "Unlock your Mustang's potential with top-tier turbo accessories from Turbosmart. Trusted by racers and tuners worldwide for unmatched boosting performance.",
    media: {
  ...
  WHITELINE: {
    ...
    metaDescription:
      "Boost balance and steering precision with Whiteline's performance suspension parts for Mustang. For significant handling gains and enhanced driving.",
    media: {
  ...
  XFORCE: {
    ...
    metaDescription:
      "Experience amplified power and sound with XFORCE's cutting-edge exhaust systems for your Mustang. Designed and dyno-tested for ultimate performance",
    media: {
  ...
  XTREME: {
    ...
    metaDescription:
      "Experience unrivaled performance with Xtreme Clutch. Professionally engineered clutch kits and components designed for your Mustang. Enhance your drive with Australia’s largest clutch manufacturer",
    media: {
